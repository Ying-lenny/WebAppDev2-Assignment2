...
import FilterControlsPeople from "../src/components/filterControlsPeople";
import PeopleHeader from "../src/components/headerPeopleList";
import PeopleList from "../src/components/peopleList";
import PeopleDetails from "../src/components/peopleDetails";
import PersonHeader from "../src/components/headerPeople";
...
storiesOf("Home Page/MovieCard", module)
  ...
  .add("exception", () => {
    const sampleNoPoster = { ...movieSample, poster_path: undefined };
    return (
      <MovieCard
...
//Popular Page
storiesOf("Popular Page/FilterControlsPeople", module)
  .addDecorator(story => (
    <GenresContextProvider>{story()}</GenresContextProvider>
  ))
  .add("default", () => (
    <FilterControlsPeople onUserInput={action("button-click")} numPeople={10} />
  ));

storiesOf("Popular Page/PeopleCard", module)
  .addDecorator(story => (
    <MemoryRouter initialEntries={["/"]}>{story()}</MemoryRouter>
  ))
  .add("default", () => (
  ...
  .add("exception", () => {
    const sampleNoPoster = { ...personSample, poster_path: undefined };
    return (
      <PeopleCard
  ...
  storiesOf("Popular Page/Header", module).add("default", () => (
    <PeopleHeader title="All People" numPeople={10} />
  ));
  
  storiesOf("Popular Page/PeopleList", module)
    .addDecorator(story => (
      <MemoryRouter initialEntries={["/"]}>{story()}</MemoryRouter>
    ))
    .add("default", () => {
...
storiesOf("Movie Details Page/MovieHeader", module)
  ...
  //People List
  storiesOf("Actor Details Page/PeopleDetails", module).add("default", () => (
    <PeopleDetails person={personSample} />
  ));
  
  storiesOf("Actor Details Page/PeopleHeader", module)
    .addDecorator(story => (
      <MemoryRouter initialEntries={["/"]}>{story()}</MemoryRouter>
    ))
